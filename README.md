...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-me5ie1u.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-me5ie1u.containers.anotherwebservice.com/
...
```
git clone git@github.com:Trey-P/container-me5ie1u.git
cd container-me5ie1u
```
...
```
docker attach container-me5ie1u
```
